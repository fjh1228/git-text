...
coco_format_save_path='/raid/-data/VisDrone2019/coco/'   #要生成的标准coco格式标签所在文件夹
yolo_format_classes_path='/raid/-data/VisDrone2019/coco/class.txt'     #类别文件，一行一个类
yolo_format_annotation_path='/raid/-data/VisDrone2019/VisDrone2019-DET-test-dev/labels/'  #yolo格式标签所在文件夹
img_pathDir='/raid/-data/VisDrone2019/VisDrone2019-DET-test-dev/images/'    #图片所在文件夹

# yolo_format_annotation_path='/raid/-data/00_567_all/labels/val'  #yolo格式标签所在文件夹
# img_pathDir='/raid/-data/00_567_all/images/val'    #图片所在文件夹
